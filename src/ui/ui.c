...
lv_obj_t * ui_SettingsScreen_Panel;
lv_obj_t * ui_SettingsScreen_Pollutant;
lv_obj_t * ui_SettingsScreen_Symbol;
lv_obj_t * ui_SettingsScreen_Container;
lv_obj_t * ui_SettingsScreen_Label;
lv_obj_t * ui_SettingsScreen_Image;
// CUSTOM VARIABLES
