...
const ui_theme_variable_t _ui_theme_color_Orange[1] = {0xFF7700};
const ui_theme_variable_t _ui_theme_alpha_Orange[1] = {255};

const ui_theme_variable_t _ui_theme_color_Green[1] = {0x20C65A};
const ui_theme_variable_t _ui_theme_alpha_Green[1] = {255};

const ui_theme_variable_t _ui_theme_color_Blue[1] = {0x002EFF};
